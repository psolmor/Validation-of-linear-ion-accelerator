...
class Element(object):
    ...
    is_point_inside_aperture = _swig_new_instance_method(_RF_Track.Element_is_point_inside_aperture)
    is_particle_inside_aperture = _swig_new_instance_method(_RF_Track.Element_is_particle_inside_aperture)
    get_aperture_area = _swig_new_instance_method(_RF_Track.Element_get_aperture_area)
    get_aperture_x = _swig_new_instance_method(_RF_Track.Element_get_aperture_x)
    get_aperture_y = _swig_new_instance_method(_RF_Track.Element_get_aperture_y)
    get_aperture_shape = _swig_new_instance_method(_RF_Track.Element_get_aperture_shape)
    set_aperture_x = _swig_new_instance_method(_RF_Track.Element_set_aperture_x)
    set_aperture_y = _swig_new_instance_method(_RF_Track.Element_set_aperture_y)
    set_aperture = _swig_new_instance_method(_RF_Track.Element_set_aperture)
    set_aperture_shape = _swig_new_instance_method(_RF_Track.Element_set_aperture_shape)
    set_width = _swig_new_instance_method(_RF_Track.Element_set_width)
    set_height = _swig_new_instance_method(_RF_Track.Element_set_height)
    get_width = _swig_new_instance_method(_RF_Track.Element_get_width)
    get_height = _swig_new_instance_method(_RF_Track.Element_get_height)
...
class Volume(Element, TrackingOptions):
    ...
    get_beam_at_tt_screens = _swig_new_instance_method(_RF_Track.Volume_get_beam_at_tt_screens)
    get_bunch_at_tt_screens = _swig_new_instance_method(_RF_Track.Volume_get_bunch_at_tt_screens)
...
class Aperture_1d(GenericField):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _RF_Track.Aperture_1d_swiginit(self, _RF_Track.new_Aperture_1d(*args))
    get_hz = _swig_new_instance_method(_RF_Track.Aperture_1d_get_hz)
    get_nz = _swig_new_instance_method(_RF_Track.Aperture_1d_get_nz)
    get_z0 = _swig_new_instance_method(_RF_Track.Aperture_1d_get_z0)
    get_z1 = _swig_new_instance_method(_RF_Track.Aperture_1d_get_z1)
    set_hz = _swig_new_instance_method(_RF_Track.Aperture_1d_set_hz)
    set_z0 = _swig_new_instance_method(_RF_Track.Aperture_1d_set_z0)
    set_z1 = _swig_new_instance_method(_RF_Track.Aperture_1d_set_z1)
    __swig_destroy__ = _RF_Track.delete_Aperture_1d

# Register Aperture_1d in _RF_Track:
_RF_Track.Aperture_1d_swigregister(Aperture_1d)
...
class Visitor(object):
    ...
    def __init__(self):
        _RF_Track.Visitor_swiginit(self, _RF_Track.new_Visitor())
...
class ConstVisitor(object):
    ...
    def __init__(self):
        _RF_Track.ConstVisitor_swiginit(self, _RF_Track.new_ConstVisitor())
